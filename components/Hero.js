  ...
  return (
    <section className="flex flex-col md:flex-row md:justify-between items-center w-full py-9">
      <div className="md:w-[45%] order-2 md:order-1">
        ...
        <p className="font-inter text-[#2A3337] dark:text-primary-dark xl:text-lg leading-[32px] 2xl:leading-[40px] my-4">Pagechap is a one-link-for-all solution that allows creators house all their content in one dynamic page.
